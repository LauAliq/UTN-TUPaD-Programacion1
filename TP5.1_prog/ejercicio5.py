...
nombres: list = ["Nahuel", "Facundo", "Lautaro", "Enzo", "Pablo", "Leandro", "Rodrigo", "Bautista"]
...
modificador: str = input("¿Desea agregar un alumno a la lista (oprima 1), eliminar un alumno (oprima 2), o dejarla como está (oprima 3)?: ")
...
modificador: int = int(modificador)
...
while bandera:
    ...
    if modificador == 1:
        agregar: str = input("Ingrese el nombre del estudiante que desea agregar a la lista: ")
    ...
    # Si el usuario quiere eliminar un nombre a la lista, este se elimina y se pregunta de nuevo qué se quiere hacer
        ...
        eliminar: str = input("Ingrese el nombre del estudiante que desea eliminar de la lista: ")
